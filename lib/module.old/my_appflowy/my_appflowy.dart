...
class MyAppflowy extends StatefulWidget {
  MyAppflowy({
    super.key,
  ...
  ///
  /// The drop target is rendered in the [MyAppflowy] using the [DesktopSelectionService]
  ...
  @override
  State<MyAppflowy> createState() => _MyAppflowyState();
}

class _MyAppflowyState extends State<MyAppflowy> {
  Widget? services;
  ...
  @override
  void didUpdateWidget(covariant MyAppflowy oldWidget) {
