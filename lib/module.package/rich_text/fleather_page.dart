...
class FleatherPage extends StatefulWidget {
  const FleatherPage({super.key});

  @override
  State<FleatherPage> createState() => _FleatherPageState();
}

class _FleatherPageState extends State<FleatherPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(elevation: 0, title: const Text('Fleather富文本')),
