import 'package:f_learner/module.package/graph_editor/graphview/algorithm_selector_graphview.dart';
import 'package:f_learner/module.package/graph_editor/graphview/decision_tree_screen.dart';
import 'package:f_learner/module.package/graph_editor/graphview/large_tree_graphview.dart';
import 'package:f_learner/module.package/graph_editor/graphview/layer_graphview.dart';
import 'package:f_learner/module.package/graph_editor/graphview/mindmap_graphview.dart';
import 'package:f_learner/module.package/graph_editor/graphview/mutliple_forest_graphview.dart';
import 'package:f_learner/module.package/graph_editor/graphview/tree_graphview_json.dart';
...
class GraphviewPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('graphview')),
      body: Container(
